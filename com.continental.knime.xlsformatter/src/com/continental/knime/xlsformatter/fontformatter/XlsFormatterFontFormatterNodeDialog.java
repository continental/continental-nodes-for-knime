...
public class XlsFormatterFontFormatterNodeDialog extends DefaultNodeSettingsPane {
	...
	protected XlsFormatterFontFormatterNodeDialog() {
		...
		tag = new SettingsModelString(XlsFormatterFontFormatterNodeModel.CFGKEY_TAGSTRING, XlsFormatterFontFormatterNodeModel.DEFAULT_TAGSTRING);
		...
		SettingsModelInteger size = new SettingsModelInteger(XlsFormatterFontFormatterNodeModel.CFGKEY_SIZE, XlsFormatterFontFormatterNodeModel.DEFAULT_SIZE);
		...
		SettingsModelColor fontcolor = new SettingsModelColor(XlsFormatterFontFormatterNodeModel.CFGKEY_FONTCOLOR, XlsFormatterFontFormatterNodeModel.DEFAULT_FONTCOLOR);
		...
		changeColor.addChangeListener(new ChangeListener(){
			public void stateChanged(final ChangeEvent e) {
